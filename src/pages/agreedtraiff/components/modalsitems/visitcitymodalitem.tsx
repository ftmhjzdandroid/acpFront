...
export default function Visitcitymodalitem(props: prpps) {
     const handelsubmit = () => {
    console.log();
  };
  return (
       ...
       <form onSubmit={handelsubmit}>
          ...
          <div className="flex flex-col">
            ...
            <div className=" grid grid-cols-4 mt-3 gap-3">
                <div className="flex flex-col">
                <div className="flex">
                    <Typography className="pb-2">قیمت کل ویزیت</Typography>
                    <Typography className="pb-2 text-red-600">*</Typography>
                </div>
                ...
                <div className="flex flex-col">
                <div className="flex">
                    <Typography className="pb-2">قیمت سهم سازمان</Typography>
                    <Typography className="pb-2 text-red-600">*</Typography>
                </div>
                <Input type="text"className="border-[#E8E8E9] bg-[#FEFEFE] p-3 pl-20 rounded-md text-xs border-2"placeholder="نام واسط را وارد کنید"/>
                </div>
