...
export default function Vpricemodal(props: Props) {
  ...
  return (
    <div>
      <Typography type="h2" className="text-badgeTextColor mb-2">افزودن قیمت ویزیت</Typography>
      <Typography className="mb-3">تعرفه قیمت ویزیت مربوط به 1402 را وارو کنید</Typography>
