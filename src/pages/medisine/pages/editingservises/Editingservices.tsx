  ...
  return (
    <div>
      ...
      <div className="flex justify-end pt-5"> 
        <Button label="مرحمه بعد" onClick={()=>Navigate.to('/medisine/editingservusespage2')} className="text-[#eee] bg-[#3949AB] p-3 w-1/3 flex justify-center" leftIcon={<ArrowLeft color="#eee"/>} type="button" size="xs"></Button>
      </div>
    </div>
  );
}
