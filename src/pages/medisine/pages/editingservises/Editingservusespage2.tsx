...
import { ArrowDown2, ArrowLeft, Folder2, FormatSquare, TickCircle } from "iconsax-react";
import { Input, Typography } from "../../../../components/atoms";
import { Button } from "../../../../components/molecules";


export default function Editingservusespage2() {
  ...
  return (
    <div className="">
      ...
      <div className="flex justify-end w-full pt-5"> 
        <Button label="ثبت" className="text-[#eee] bg-[#3949AB] p-3 w-1/3 flex justify-center" leftIcon={<ArrowLeft color="#eee"/>} type="button" size="xs"></Button>
      </div>
    </div>
  );
}
